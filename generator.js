...
function drawing(btn, title, arr) {
  switch (arr.length) {
    case 1:
      drawTitle(btn, title, arr); //write title = space and participants number to multiply 20 for div height
      break;
    case 2:
...
function drawEleven(btn, title, arr) {
  ...
  draw.polyline("0,90 40,90 40,65").fill("none").move(270, 495).stroke({
    // eleventh box bracket
    color: "#9b0000",
    width: 2,
  });
  draw.polyline("0,50 40,50 40,0").fill("none").move(310, 445).stroke({
    // tenth-eleventh box bracket
    color: "#9b0000",
    width: 2,
  });
  draw.polyline("0,0 80,0 80,70").fill("none").move(310, 295).stroke({
  ...
  draw.polyline("0,0 40,0 40,50").fill("none").move(310, 395).stroke({
    // eighth-nineth bracket
    color: "#00099b",
    width: 2,
  });
  draw.polyline("0,80 40,80 40,0").fill("none").move(350, 365).stroke({
    // eighth-tenth bracket
    color: "#9b0000",
    width: 2,
  });
  ...
  draw.polyline("25,0 0,0 0,20 25,20").fill("none").move(324, 435).stroke({
    // seventh round box
    color: "#000",
    width: 1,
  });
...
//   let draw = SVG().addTo(`.bagan-${btn}`).attr({
//     id: `bagan-${btn}`,
//     width: 480,
//     height: 592
//   })
//   draw.rect(250, 20).radius(3).attr({ // first box
//     x: 20,
//     y: 10,
//     fill: 'white',
//     stroke: '#0004ff',
//     'stroke-width': 2
//   })
//   draw.rect(250, 20).radius(3).attr({ // second box
//     x: 20,
//     y: 60,
//     fill: 'white',
//     stroke: '#ea0000',
//     'stroke-width': 2
//   })
//   draw.rect(250, 20).radius(3).attr({ // third box
//     x: 20,
//     y: 110,
//     fill: 'white',
//     stroke: '#0004ff',
//     'stroke-width': 2
//   })
//   draw.rect(250, 20).radius(3).attr({ // fourth box
//     x: 20,
//     y: 160,
//     fill: 'white',
//     stroke: '#ea0000',
//     'stroke-width': 2
//   })
//   draw.rect(250, 20).radius(3).attr({ // fifth box
//     x: 20,
//     y: 210,
//     fill: 'white',
//     stroke: '#0004ff',
//     'stroke-width': 2
//   })
//   draw.rect(250, 20).radius(3).attr({ // sixth box
//     x: 20,
//     y: 260,
//     fill: 'white',
//     stroke: '#ea0000',
//     'stroke-width': 2
//   })
//   draw.rect(250, 20).radius(3).attr({ // seventh box
//     x: 20,
//     y: 310,
//     fill: 'white',
//     stroke: '#0004ff',
//     'stroke-width': 2
//   })
//   draw.rect(250, 20).radius(3).attr({ // eighth box
//     x: 20,
//     y: 360,
//     fill: 'white',
//     stroke: '#ea0000',
//     'stroke-width': 2
//   })
//   draw.rect(250, 20).radius(3).attr({ // nineth box
//     x: 20,
//     y: 410,
//     fill: 'white',
//     stroke: '#0004ff',
...
//     'stroke-width': 2
//   })
//   draw.rect(250, 20).radius(3).attr({ // eleveth box
//     x: 20,
//     y: 510,
//     fill: 'white',
//     stroke: '#0004ff',
//     'stroke-width': 2
//   })
//   draw.rect(250, 20).radius(3).attr({ // twelve box
//     x: 20,
//     y: 560,
//     fill: 'white',
//     stroke: '#ea0000',
//     'stroke-width': 2
//   })
//   draw.text(arr[0]).font({ // first box name
//     x: 24,
//     y: 25,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[1]).font({ // second box name
//     x: 24,
//     y: 75,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[2]).font({ // third box name
//     x: 24,
//     y: 125,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[3]).font({ // fourth box name
//     x: 24,
//     y: 175,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[4]).font({ // fifth box name
//     x: 24,
//     y: 225,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[5]).font({ // sixth box name
//     x: 24,
//     y: 275,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[6]).font({ // seventh box name
//     x: 24,
//     y: 325,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[7]).font({ // eighth box name
//     x: 24,
//     y: 375,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[8]).font({ // nineth box name
//     x: 24,
//     y: 425,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[9]).font({ // tenth box name
//     x: 24,
//     y: 475,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[10]).font({ // eleventh box name
//     x: 24,
//     y: 525,
//     fill: 'black',
//     size: 12
//   })
//   draw.text(arr[11]).font({ // twelveth box name
//     x: 24,
//     y: 575,
//     fill: 'black',
//     size: 12
//   })
//   draw.polyline('0,0 40,0 40,25').fill('none').move(270, 20).stroke({ // first box bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('0,0 40,0 40,50').fill('none').move(310, 45).stroke({ // first-second box bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('0,25 40,25 40,0').fill('none').move(270, 45).stroke({ // second box bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('250,50 290,50 290,75').fill('none').move(270, 120).stroke({ // third box bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('250,240 290,240 290,215').fill('none').move(270, 145).stroke({ // fourth box bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('0,195 40,195 40,145').fill('none').move(310, 95).stroke({ // third-fourth bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('0,0 40,0 40,80').fill('none').move(350, 95).stroke({ // first-fourth bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('250,50 290,50 290,75').fill('none').move(270, 220).stroke({ // fifth box bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('250,240 290,240 290,215').fill('none').move(270, 245).stroke({ // sixth box bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('0,195 80,195 80,125').fill('none').move(310, 175).stroke({ // fifth-sixth bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('250,50 290,50 290,75').fill('none').move(270, 320).stroke({ // seventh box bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('250,90 290,90 290,65').fill('none').move(270, 345).stroke({ // eighth box bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('250,50 290,50 290,75').fill('none').move(270, 420).stroke({ // nineth box bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('250,90 290,90 290,65').fill('none').move(270, 445).stroke({ // tenth box bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('250,50 290,50 290,75').fill('none').move(270, 520).stroke({ // eleventh box bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('0,90 40,90 40,65').fill('none').move(270, 545).stroke({ // twelveth box bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('0,50 40,50 40,0').fill('none').move(310, 495).stroke({ // eleventh-twelveth box bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('0,0 80,0 80,70').fill('none').move(310, 345).stroke({ // seventh-eighth bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('0,0 40,0 40,50').fill('none').move(310, 445).stroke({ // nineth-tenth bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('0,80 40,80 40,0').fill('none').move(350, 415).stroke({ // nineth-twelveth bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('0,0 40,0 40,120').fill('none').move(390, 175).stroke({ // firsth-sixth bracket
//     color: '#00099b',
//     width: 2
//   })
//   draw.polyline('0,120 40,120 40,0').fill('none').move(390, 295).stroke({ // seventh-twelveth bracket
//     color: '#9b0000',
//     width: 2
//   })
//   draw.polyline('0,0 30,0').fill('none').move(430, 295).stroke({ // champion bracket
//     color: 'gold',
//     width: 2
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(284, 35).stroke({ // first round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // first round text
//     x: 297,
//     y: 47,
//     fill: 'black',
//     size: 14,
...
//     'dominant-baseline': 'middle'
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(284, 135).stroke({ // second round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // second round text
//     x: 297,
//     y: 147,
//     fill: 'black',
//     size: 14,
...
//     'dominant-baseline': 'middle'
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(284, 235).stroke({ // third round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // third round text
//     x: 297,
//     y: 247,
//     fill: 'black',
//     size: 14,
...
//     'dominant-baseline': 'middle'
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(284, 335).stroke({ // fourth round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // fourth round text
//     x: 297,
//     y: 347,
//     fill: 'black',
//     size: 14,
...
//     'dominant-baseline': 'middle'
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(284, 435).stroke({ // fifth round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // fifth round text
//     x: 297,
//     y: 447,
//     fill: 'black',
//     size: 14,
...
//     'dominant-baseline': 'middle'
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(284, 535).stroke({ // sixth round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // sixth round text
//     x: 297,
//     y: 547,
//     fill: 'black',
//     size: 14,
...
//     'dominant-baseline': 'middle'
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(324, 85).stroke({ // seventh round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // seventh round text
//     x: 337,
//     y: 97,
//     fill: 'black',
//     size: 14,
...
//     'dominant-baseline': 'middle'
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(324, 485).stroke({ // eighth round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // eighth round text
//     x: 337,
//     y: 497,
//     fill: 'black',
//     size: 14,
...
//     'dominant-baseline': 'middle'
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(364, 165).stroke({ // nineth round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // nineth round text
//     x: 377,
//     y: 177,
//     fill: 'black',
//     size: 14,
...
//     'dominant-baseline': 'middle'
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(364, 405).stroke({ // tenth round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // tenth round text
//     x: 377,
//     y: 417,
//     fill: 'black',
//     size: 14,
...
//     'dominant-baseline': 'middle'
//   })
//   draw.polyline('25,0 0,0 0,20 25,20').fill('none').move(404, 285).stroke({ // champion round box
//     color: '#000',
//     width: 1
//   })
//   draw.plain('...').font({ // champion round text
//     x: 417,
//     y: 297,
//     fill: 'black',
//     size: 14,
